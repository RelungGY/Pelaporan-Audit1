...
<head>
    ...
    <link href="{{ asset('assets/sbadmin/css/custom.css') }}" rel="stylesheet">
    <script src="https://kit.fontawesome.com/7ac0febd4e.js" crossorigin="anonymous"></script>
    <!-- SweetAlert2 CSS -->
