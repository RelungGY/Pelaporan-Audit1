                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fa-solid fa-people-carry-box"></i>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    fetch("{{ route('transactions.chart-data') }}")
        .then(response => response.json())
        .then(data => {
            // Area Chart
            const monthlyEarningsLabels = Object.keys(data.monthlyEarnings);
            const monthlyEarningsValues = Object.values(data.monthlyEarnings);
            ...
            // Pie Chart
            const statusLabels = Object.keys(data.statusCount);
            const statusValues = Object.values(data.statusCount);
